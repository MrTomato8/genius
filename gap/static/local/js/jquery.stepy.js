  ...
  var methods = {
    init: function(settings) {
      return this.each(function() {
        ...
        self.heads.addClass('button button-gray');
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: 'javascript:void(0);', 'class': 'button button-back', html: self.opt.backLabel };
      ...
      var self       = this,
          that       = $(this),
          attributes = { href: 'javascript:void(0);', 'class': 'button button-next', html: self.opt.nextLabel };
      ...
      return $('<p class="stepy-navigator grid-8 float-left" />');
