...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.hash_code'
        db.add_column('quotes_quote', 'hash_code',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('quotes_quote', ['user_id', 'hash_code'])

        # Deleting field 'Quote.hash_code'
        db.delete_column('quotes_quote', 'hash_code')
    ...
    models = {
        ...
        'quotes.quote': {
            'Meta': {'ordering': "['-date_added']", 'unique_together': "(('user', 'hash_code'),)", 'object_name': 'Quote'},
            'caption': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'blank': 'True'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_expired': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 6, 0, 0)'}),
            'hash_code': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '35'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'quotes.quoteline': {
            ...
            'price': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2'}),
