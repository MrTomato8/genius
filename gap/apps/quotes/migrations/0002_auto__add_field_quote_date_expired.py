...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.date_expired'
        db.add_column('quotes_quote', 'date_expired',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 16, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.date_expired'
        db.delete_column('quotes_quote', 'date_expired')
    ...
    models = {
        ...
        'quotes.quote': {
            ...
            'date_expired': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 16, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Product']"}),
