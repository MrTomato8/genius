...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuoteLine.price'
        db.add_column('quotes_quoteline', 'price',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuoteLine.price'
        db.delete_column('quotes_quoteline', 'price')
    ...
    models = {
        ...
        'quotes.quote': {
            ...
            'date_expired': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 5, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
