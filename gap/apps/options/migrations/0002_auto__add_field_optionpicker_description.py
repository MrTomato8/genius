...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OptionPicker.description'
        db.add_column('options_optionpicker', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OptionPicker.description'
        db.delete_column('options_optionpicker', 'description')
