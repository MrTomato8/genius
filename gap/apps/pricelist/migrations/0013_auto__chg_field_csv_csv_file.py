...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CSV.csv_file'
        db.alter_column('pricelist_csv', 'csv_file', self.gf('django.db.models.fields.files.FileField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'CSV.csv_file'
        db.alter_column('pricelist_csv', 'csv_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
