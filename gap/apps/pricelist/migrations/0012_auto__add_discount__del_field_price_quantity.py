...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('pricelist_discount', (
            ...
            ('price', self.gf('django.db.models.fields.related.ForeignKey')(related_name='discounts', to=orm['pricelist.Price'])),
        ))
        db.send_create_signal('pricelist', ['Discount'])

        # Deleting field 'Price.quantity'
        db.delete_column('pricelist_price', 'quantity')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Price.quantity'
        db.add_column('pricelist_price', 'quantity',
