...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Price.min_length'
        db.add_column('pricelist_price', 'min_length',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=3),
                      keep_default=False)

        # Adding field 'Price.media_width'
        db.add_column('pricelist_price', 'media_width',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Price.min_length'
        db.delete_column('pricelist_price', 'min_length')

        # Deleting field 'Price.media_width'
        db.delete_column('pricelist_price', 'media_width')
