...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Discount.quantity'
        db.alter_column('pricelist_discount', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Discount.quantity'
        db.alter_column('pricelist_discount', 'quantity', self.gf('django.db.models.fields.IntegerField')())
