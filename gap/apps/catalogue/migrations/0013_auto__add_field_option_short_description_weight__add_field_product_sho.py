...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Option.short_description_weight'
        db.add_column('catalogue_option', 'short_description_weight',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.short_title'
        db.add_column('catalogue_product', 'short_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Option.short_description_weight'
        db.delete_column('catalogue_option', 'short_description_weight')

        # Deleting field 'Product.short_title'
        db.delete_column('catalogue_product', 'short_title')
