...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Line.custom_price'
        db.add_column('basket_line', 'custom_price',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Line.custom_price'
        db.delete_column('basket_line', 'custom_price')
    ...
    models = {
        ...
        'basket.line': {
            ...
            'custom_price': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
